// this is how NULL used to be defined, in modern C++ NULL is often defined as nullptr
#define NULL 0
...
int main(int, char **) {
    ...
    // bool valid = nullptr;        // error, except if direct initialisation enabled during compilation
